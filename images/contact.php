...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$csrf_ok || !$honeypot_ok) {
        ...
        try {
            $replyMailer = makeMailer($_cfg);
            $replyMailer->addAddress($email, $name);
            $replyMailer->Subject = $reply_subject;
            $replyMailer->Body    = $reply_body;
            $replyMailer->send();
...
<head>
  ...
  <title>聯絡我們 Contact｜NUDOT 核點創意・台中網頁設計與商業視覺合作洽詢</title>

  <!-- SEO -->
  <meta name="description" content="與 NUDOT 核點創意聯繫 — 台中網頁設計、高階商業視覺與 AI 動態影像團隊。歡迎洽詢品牌官網、互動體驗設計與 Gen-AI 視覺合作專案。">
  <meta name="keywords"
    content="NUDOT 聯絡, 核點創意聯繫, 台中網頁設計洽詢, 網站設計合作, 高階商業視覺, AI 動態影像, 品牌識別設計, Gen-AI Visual, 接案洽詢, 商業攝影視覺">
  <meta name="robots" content="index, follow">
  <meta name="author" content="NUDOT 核點創意">
  ...
  <meta property="og:title" content="聯絡我們 Contact｜NUDOT 核點創意・台中網頁設計與商業視覺合作洽詢">
  <meta property="og:description" content="與 NUDOT 核點創意聯繫 — 台中網頁設計、高階商業視覺與 AI 動態影像團隊。歡迎洽詢品牌官網、互動體驗設計與 Gen-AI 視覺合作專案。">
  <meta property="og:image" content="https://nudot.com.tw/images/og.jpg">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta property="og:locale" content="zh_TW">
  <meta property="og:site_name" content="NUDOT 核點創意">

  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="聯絡我們 Contact｜NUDOT 核點創意・台中網頁設計與商業視覺合作洽詢">
  <meta name="twitter:description" content="與 NUDOT 核點創意聯繫 — 台中網頁設計、高階商業視覺與 AI 動態影像團隊，洽詢品牌官網與 Gen-AI 視覺合作。">
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Bitcount+Grid+Single:wght@100..900&family=Bitcount+Prop+Single:wght@100..900&family=DM+Sans:ital,opsz,wght@0,9..40,100..1000;1,9..40,100..1000&family=Doto:wght@100..900&family=Zalando+Sans+SemiExpanded:ital,wght@0,200..900;1,200..900&display=swap">
  <link rel="stylesheet" href="cursor-shared.css?v=20260517">
  <link rel="stylesheet" href="nav-menu-shared.css?v=20260613">
  <link rel="stylesheet" href="page-transitions.css">
  <link rel="stylesheet" href="project-creative-process.css">
  ...
  <script src="./transitions.js?v=20260517-4" defer></script>
  <script src="project-creative-process.js" defer></script>
  <script src="cursor-shared.js" defer></script>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 768px) {
      .cb-float { display: none; }
      .cb-line { font-size: clamp(2.6rem, 10vw, 4.5rem); }
    }
    ...
    .field-group:focus-within { border-bottom-color: #555; }
    ...
    .field-group textarea.invalid { color: #e55; }

    .field-group input.valid,
    .field-group textarea.valid { color: #fff; }
    ...
    .budget-tag-remove:hover { color: #fff; }
    ...
    .budget-price-offers { display: flex; flex-wrap: wrap; gap: 8px; }
    ...
    /* captcha */
    .captcha-block { border-bottom: 1px solid #222; }
    ...
    .captcha-input-wrap input::-webkit-inner-spin-button { -webkit-appearance: none; }

    .captcha-input-wrap input:focus { border-bottom-color: #fff; }
   ...
   .footer-parallax-section {
    ...
    .contact-hero .mobile_work-hero__title { display: none;  font-size: 65px; }
    ...
    #lb-close:hover { background: #fff; color: #000; }

    /* ── Responsive ── */
    @media (max-width: 1024px) {
      .footer-copyright-bridge { display: none !important; }
    }

    @media (max-width: 768px) {
      /* Hero: show CONTACT div, hide LET'S / center / TALK */
      .contact-hero .mobile_work-hero__title { display: block; }
      .contact-hero h1.work-hero__title      { display: none; }
      .contact-hero .work-hero__center       { display: block; }
      .contact-hero .work-hero__code         { display: none; }

      .info-grid { grid-template-columns: 1fr; }
      .field-group { grid-template-columns: 1fr; gap: 6px 0; }
      .field-group label { padding-top: 0; }
      .field-group .field-error { grid-column: 1; }
      .budget-section { grid-template-columns: 1fr; gap: 12px 0; }
      .budget-price-section { grid-template-columns: 1fr; gap: 10px 0; }
      .budget-price-section.is-visible { max-height: 260px; }
      .budget-selected-row { grid-template-columns: 1fr; gap: 10px 0; }
      .budget-selected-row.is-visible { max-height: 200px; }
      .captcha-eq-row { grid-template-columns: 1fr; gap: 12px 0; }
      .captcha-block .field-error { padding-left: 0; }
      ...
      .footer-info-bar { flex-direction: column; gap: 8px; }
    }
    ...
    .contact-entered .contact-content { opacity: 1; transform: translateY(0) translateZ(0); }
    .contact-entered .top-desc        { opacity: 1; }
    .contact-entered .line            { transform: scaleX(1); }
    .contact-entered .info-grid > *   { opacity: 1; transform: translateY(0) translateZ(0); }
    .contact-entered .form-area       { opacity: 1; }
    ...
    @media (prefers-reduced-motion: reduce) {
      .contact-marquee__track { transform: none !important; }
    }
  </style>
</head>
...
<body class="shared-nav-page page-work-pattern">
    ...
    <div class="page-transition-frame js-page-transition-frame">
      ...
      <div class="page-transition-panel js-page-transition-panel">
        ...
        <div class="page-transition-copy">
          <div class="page-transition-eyebrow js-page-transition-eyebrow">NUDOT CREATIVE STUDIO</div>
 ...
 <div class="work-hero__bottom">
      ...
      <main class="page-container">
        <div class="page">
          ...
          <div class="form-area">
            ...
            <form id="contactForm" method="POST" action="contact" novalidate>
              ...
              <input type="text" name="_hp" value="" aria-hidden="true" tabindex="-1" autocomplete="off" style="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden;">
              ...
              <div class="form-fields">
                ...
                <div class="field-group">
                  <label for="f_company">Company ／ 公司名稱 <span style="font-size:10px;opacity:0.45;letter-spacing:0.05em;">(optional ／ 非必填)</span></label>
                ...
                <div class="field-group field-full">
                  ...
                  <textarea id="f_msg" name="message" placeholder="Tell us about your project... ／ 請描述您的專案需求"><?= htmlspecialchars($_POST['message'] ?? '') ?></textarea>
                ...
                <div class="budget-section">
                  ...
                  <div class="budget-offers" aria-label="Budget scale">
                    <button type="button" class="budget-offer-btn<?= $selBudget === '網站設計' ? ' is-active' : '' ?>" data-budget="網站設計">網站設計</button>
                    <button type="button" class="budget-offer-btn<?= $selBudget === '品牌識別' ? ' is-active' : '' ?>" data-budget="品牌識別">品牌識別</button>
                   
                    <button type="button" class="budget-offer-btn<?= $selBudget === '高階商業視覺圖像生成' ? ' is-active' : '' ?>" data-budget="高階商業視覺圖像生成">高階商業視覺圖像生成</button>
                    <button type="button" class="budget-offer-btn<?= $selBudget === 'AI動態影像' ? ' is-active' : '' ?>" data-budget="AI動態影像">AI 動態影像</button>
                  </div>
                </div>
        ...
        <div class="contact-marquee" aria-hidden="true">
          <div class="contact-marquee__track" id="contact-marquee-track">
            ...
            <span class="contact-marquee__sep"><img src="images/contact.svg" alt=""></span>
            <span class="contact-marquee__item">LET'S TALK</span>
            <span class="contact-marquee__sep"><img src="images/contact.svg" alt=""></span>
            <span class="contact-marquee__item">LET'S TALK</span>
            <span class="contact-marquee__sep"><img src="images/contact.svg" alt=""></span>
      ...
      <div class="footer-top">
        <div class="footer-main-content">
          <div>
            <div class="footer-contact-info">
              <a href="mailto:nudotlabs@gmail.com">nudotlabs@gmail.com</a>
              <span>+8869 83 750 522</span>
            </div>
            <div style="color:#444;font-size:14px;margin-top:8px;">臺中市北屯區文心路三段447號</div>
            <nav class="footer-nav-links">
              <a href="https://www.instagram.com/nudotlabs" target="_blank" rel="noopener noreferrer" data-transition-label="Instagram">Instagram</a>
              <a href="https://www.threads.com/@nudotlabs" target="_blank" rel="noopener noreferrer" data-transition-label="Threads">Threads</a>
              <a href="https://www.facebook.com/profile.php?id=61588727983387&locale=zh_TW" target="_blank" rel="noopener noreferrer" data-transition-label="Facebook">Facebook</a>
            </nav>
          </div>
        ...
        <div class="footer-parallax-section" id="footer-parallax-section">
          ...
          <div class="footer-parallax-copy">
            <div>核點創意有限公司</div>
            <div>&#169; 2026 NUDOT CREATIVE STUDIO. ALL RIGHTS RESERVED.</div>
          </div>        </div>
  ...
  <div id="lb-overlay">
    <div id="lb-box">
      <div id="lb-mark">
        <video autoplay muted loop playsinline disableRemotePlayback style="height:50px;width:auto;display:block;margin:0 auto;">
          <source src="images/contact.svg" type="video/mp4">
        </video>
      </div>
      <div id="lb-title"><span>RECEIVED</span> <br> 已收到</div>
  ...
  <div id="cursor-ring" aria-hidden="true" data-cursor-label="EXPLORE" data-cursor-side="right" style="position: fixed;"></div>
